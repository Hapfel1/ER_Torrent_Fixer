...
from .er_types import FloatVector3, FloatVector4, MapId, HorseState
...
class Regions:
    ...
    Then continues parsing - this is NOT a fixed-size structure!
    """
    count: int = 0
...
class RideGameData:
    ...
    Contains position, HP, and state. This is where the infamous Torrent bug occurs!
    """
